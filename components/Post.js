    ...
    return(
        <main className="">
            ...
            <div className="shadow-md relative">
                ...
                <svg class="w-5 text-primary inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span className="text-primary hover:shadow-inner"> 5 Mins ago</span>
                </div>
            </div>

            <div className=" w-full md:text-lg flex bg-secondary-100 " >
                <h2 className="text-primary text-center font-bold sm:text-xl md:p-4 p-4 ">is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
